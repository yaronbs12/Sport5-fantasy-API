"""
UEFA Champions League fantasy connector.

Targets the Sport5 shared backend at ``https://dreamteam.sport5.co.il``.
The default season ID is ``12``; ``discover_season_id()`` will update
this dynamically from ``/api/Leagues/GetLeagues``.
"""
...
class ChampionsLeagueConnector(BaseSport5Connector):
    """
    Connector for the UEFA Champions League fantasy platform.

    Upstream base URL:  ``https://dreamteam.sport5.co.il``
    Default season ID:  ``12``
    """

    @property
    def base_url(self) -> str:
        return settings.champions_league_base_url

    @property
    def default_season_id(self) -> int:
        return settings.champions_league_default_season_id

    @property
    def tournament_type(self) -> TournamentType:
        return TournamentType.CHAMPIONS_LEAGUE
